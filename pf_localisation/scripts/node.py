...
class ParticleFilterLocalisationNode(object):
    def __init__(self):
        ...
        self._pose_publisher = rospy.Publisher("/estimatedpose", PoseStamped, queue_size=queue_size)
        self._amcl_pose_publisher = rospy.Publisher("/amcl_pose",
                                                    PoseWithCovarianceStamped, queue_size=queue_size)
        self._cloud_publisher = rospy.Publisher("/particlecloud", PoseArray, queue_size=queue_size)
        self._tf_publisher = rospy.Publisher("/tf", tfMessage, queue_size=queue_size)
        ...
        self._particle_filter.set_map(self.ocuccupancy_map)
